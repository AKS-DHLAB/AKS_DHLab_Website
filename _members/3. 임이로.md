...
- **한국현대문학자대회 Web Design/publisher**, 한국현대문학자대회, Jun. 2025 - Present
...
### Articles
1. **LIM, I.**, Ji, H., & Kim, B. (2025). **KPoEM: A Human-Annotated Dataset for Emotion Classification and RAG-Based Poetry Generation in Korean Modern Poetry**. *arXiv preprint*. <i class="ai ai-doi"></i> <a href="https://arxiv.org/abs/2509.03932" target="_blank">10.48550/arXiv.2509.03932</a>

### Talks/Presentations
- **임이로** & 김병준. (2026.01.23) **Co-Reading: A Human-AI Co-Reader Media System for Poetry-Emotion-Color**. HKADH 2026 Conference , Hong Kong Association for Digital Humanities (HKADH), 서울, 대한민국.
- **임이로**. (2025.12.96) **데이터셋의 환경적 전환: 인공지능과 함께 읽기(Co-Reading)를 통한 한국 근현대 시–감정–색채 멀티모달 미디어**. 영화와 미디어의 낯선 경계, 매개하는 연구들 , 중앙대학교 영화미디어학샌터 대학원생 컨퍼런스, 서울, 대한민국.
- **임이로**, 지해인, & 김병준. (2025.10.18). **한국 근현대시의 감정 분석과 인공지능 시 창작 응용: KPoEM 데이터셋 구축과 활용**. 반교어문학회 제180차 정기학술대회, 성균관대학교, 서울, 대한민국.
...
2. KCoEM (Korean Color Emotion Mapping) dataset
